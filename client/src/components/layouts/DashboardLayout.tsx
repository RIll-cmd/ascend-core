...
import { StudioDrawerProvider } from "@/features/editor/context/StudioDrawerContext";
import { StudioSidebarTrigger } from "@/features/editor/components/StudioSidebarTrigger";
import { StudioSidebarDrawer } from "@/features/editor/components/StudioSidebarDrawer";

export function DashboardLayout({ children }: { children: React.ReactNode }) {
  useAiraNotification();

  return (
    <StudioDrawerProvider>
      <div
