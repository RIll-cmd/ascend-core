...
export default function AiraTerminalPage() {
  ...
  return (
    <div className="aira-neo-theme relative flex-1 flex flex-col gap-4 max-w-7xl w-full mx-auto font-sans text-foreground min-h-0 animate-in fade-in duration-300">
      {/* AIRA swoosh background — covers entire aira viewport */}
      <div
        aria-hidden="true"
        className="pointer-events-none fixed inset-0 z-0"
        style={{
          backgroundImage: "url('/backgrounds/aira-neo-swoosh.png')",
